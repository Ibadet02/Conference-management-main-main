...
import { reviewerSidebarLinks } from "../../../../data/components/dashboard/Reviewer/ReviewerSidebarLinks";
    ...
    >
      <div className="author-sidebar__top-wrapper">
        ...
        <div className="author-sidebar__middle">
          {reviewerSidebarLinks.map((linkBox) => {
            return (
                  ...
                  {linkBox.links.map((link) => {
                    return (
                      <NavLink
                        ...
                        to={`/reviewer-dashboard${link.path}`}
                      >
